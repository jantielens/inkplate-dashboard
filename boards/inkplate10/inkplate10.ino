/*
   Inkplate10 Dashboard
   
   Multi-board dashboard project for Inkplate devices.
   This is the Inkplate 10 specific sketch.
...
#error "Wrong board selection for this sketch, please select Soldered Inkplate10 in the boards menu."
#endif
